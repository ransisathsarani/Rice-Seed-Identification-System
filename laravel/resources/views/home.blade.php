...
<div class="text-center">
    ...
    <br>
    <!-- <br>
    <button type="button" class="home_btn btn-info btn-lg btn-block" onclick="window.location = 'http://127.0.0.1:8000/seed-images/details'"><i class="fa fa-camera"></i> Capture an Image</button> -->
</div>
@endsection